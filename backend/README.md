...
## Project Structure
    ...
    ├── testapiautoteammemb_68145  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_68145`
...
2. Clone this repo and `cd testapiautoteammemb_68145`
